    ...
    <div class="flex justify-center items-center md:items-start md:mt-20 h-full">
      <div class="relative p-4 w-full max-w-xl  bg-white rounded-lg shadow-lg dark:bg-gray-700 overflow-y-auto">
        ...
        <div class="flex items-center justify-between p-4 border-b rounded-t dark:border-gray-600 border-gray-200">
          <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Alerta [COD-001]</h3>
          <button @click="close" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white">
            <IconX />
          </button>
        </div>
        <!-- Body del Modal -->
        <div class="mt-2.5">
          <div class="grid grid-cols-2  gap-4 md:gap-2.5 ">
            ...
            <div class="flex col-span-2 md:col-span-1 flex-col gap-2 text-[14px] font-regular ">
              ...
              <div class="flex gap-4">
                <IconFlame class="text-red-500"/>
                <p class="text-colorText333 dark:text-white">Incendio</p>
              </div>
            </div>
          </div>
          <div class="bg-gray-100 dark:bg-gray-600 my-3 pb-2 rounded-[12px]">
            <div class="py-1 px-4 bg-blue-600 rounded-t-[12px]">
              <h3 class="text-white">Descripción de alerta</h3>
            </div>
            <div class="py-2 px-4">
              <p class="text-colorText333 dark:text-white">Esta es una descripción de alerta de ejemplo </p>
            </div>
          </div>
          <div class="mt-5 grid grid-cols-2 gap-5">
            <div class="flex col-span-2 md:col-span-1 rounded-md shadow-xs" role="group">
              <div class="relative flex flex-1">
                <input
                    ...
                    :disabled="isFalsaAlarma"
                    class="hidden peer"
                />
                <label
                    for="radio-en-camino"
                    class="w-full cursor-pointer px-6 py-2.5 text-[16px] font-medium text-gray-900 bg-white border border-gray-200 rounded-s-lg
                  hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700
                  dark:bg-gray-600 dark:border-gray-500 dark:text-gray-100 dark:hover:text-white dark:hover:bg-gray-500 dark:focus:ring-blue-400 dark:focus:text-white
              ...
              <div class="relative flex flex-1">
                ...
                <label
                    for="radio-atendido"
                    class="w-full cursor-pointer px-6 py-2.5 text-[16px] font-medium text-gray-900 bg-white border border-gray-200 rounded-e-lg
                  hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700
                  dark:bg-gray-600 dark:border-gray-500 dark:text-gray-100 dark:hover:text-white dark:hover:bg-gray-500 dark:focus:ring-blue-400 dark:focus:text-white
                  peer-checked:bg-blue-700 peer-checked:text-white dark:peer-checked:bg-blue-600 dark:peer-checked:text-white"
                >
            ...
            <div class="flex col-span-2 md:col-span-1 gap-[10px]">
              <a href="/" target="_blank" class="border-2 w-full justify-center text-colorText333 dark:text-white hover:bg-green-600 hover:text-white  gap-2.5 flex border-green-600 py-2.5 px-4 rounded-[10px] transition-colors duration-300 ease-in-out">
                Seguimiento
          ...
          <div class="mt-5 flex justify-between items-center">
            <div class="flex items-center">
              <input
                  id="link-checkbox"
                  type="checkbox"
                  v-model="isFalsaAlarma"
                  class="w-4 h-4 text-red-600 bg-gray-100 border-gray-300 rounded-sm dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
              />
              <label for="link-checkbox" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Falsa Alarma</label>
            </div>
