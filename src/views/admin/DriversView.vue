...
// ----- Datos -----
const tableData = ref([
  { dni: '12345678', nombre: 'Carlos Ruiz', brevete: 'B123456', telefono: '987654321', sexo: 'Masculino', estado: 'Activo' },
  { dni: '23456789', nombre: 'Ana Torres', brevete: 'B234567', telefono: '912345678', sexo: 'Femenino', estado: 'Inactivo' },
  { dni: '34567890', nombre: 'Luis Gómez', brevete: 'B345678', telefono: '986543210', sexo: 'Masculino', estado: 'Activo' },
  { dni: '45678901', nombre: 'Lucía Pérez', brevete: 'B456789', telefono: '923456789', sexo: 'Femenino', estado: 'Inactivo' },
  { dni: '56789012', nombre: 'Marco Díaz', brevete: 'B567890', telefono: '934567890', sexo: 'Masculino', estado: 'Activo' },
  { dni: '67890123', nombre: 'Elena Rojas', brevete: 'B678901', telefono: '945678901', sexo: 'Femenino', estado: 'Inactivo' },
  { dni: '78901234', nombre: 'Pedro Ramos', brevete: 'B789012', telefono: '956789012', sexo: 'Masculino', estado: 'Activo' },
  { dni: '89012345', nombre: 'Sofía Vega', brevete: 'B890123', telefono: '967890123', sexo: 'Femenino', estado: 'Inactivo' },
  { dni: '90123456', nombre: 'Jorge Castillo', brevete: 'B901234', telefono: '978901234', sexo: 'Masculino', estado: 'Activo' },
  { dni: '01234567', nombre: 'Valeria Luna', brevete: 'B012345', telefono: '989012345', sexo: 'Femenino', estado: 'Inactivo' }
]);
...
const filteredData = computed(() => {
  return tableData.value.filter(item => {
    const matchesSearch =
        ...
        item.brevete.toLowerCase().includes(searchQuery.value.toLowerCase()); // Added brevete to search logic
    const matchesEstado =
          ...
          <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
              <tr>
                ...
                <th class="px-6 py-3">Brevete</th> <!-- Changed from Email to Brevete -->
            ...
            <tbody>
              <tr v-for="(row, index) in paginatedData" :key="index" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td class="px-6 py-4">{{ row.brevete }}</td> <!-- Display Brevete -->
                ...
                <td class="px-6 py-4 text-blue-600 hover:underline cursor-pointer">
                  <RouterLink to="infodriver" class="md:tooltip md:tooltip-left" data-tip="Ver información">
                    <button
